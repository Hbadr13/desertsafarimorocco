...
export default function EditTourPage({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/admin/tours/${params.tourId}`, {
        method: "POST",
        headers: {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-8 px-2 md:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-slate-800">Update Tour</h1>
            <p className="text-slate-500">Modify the details of your existing travel tour</p>
          </div>
