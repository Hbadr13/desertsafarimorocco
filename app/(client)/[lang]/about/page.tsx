...
export default function AboutPage({ params }: { params: { lang: Language } }) {
    ...
    const handleImageClick = (image: ImageWithPackage) => {
        router.push(`/${params.lang}/packages/${image.packageSlug}`);
    };
                ...
                <section className="space-y-8">
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto text-lg">
                            Discover the beauty of Morocco through our curated collection of desert adventures and cultural experiences.
                        </p>
                    </div>
