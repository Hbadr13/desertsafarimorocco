...
const PackageCardV2 = ({ pkg, lang }: { pkg: Package, lang: 'fr' | 'es' | 'en' }) => {
    ...
    return (
        <Card
            ...
            className="max-w-[280px] w-[80vw] border-0  overflow-hidden cursor-pointer h-full flex flex-col transition-all duration-200 group/child"
        >
            <div className="h-40 rounded-2xl=  w-full relative">
                <Swiper
                    modules={[Navigation]}
                    navigation={{
            ...
            <CardContent className="flex flex-col justify-between flex-grow p-1.5 md:p-3">
                <div className="">
                    ...
                    <p className="text-white font-medium text-xs mb-2 leading-relaxed line-clamp-3">
